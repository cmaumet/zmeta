%-----------------------------------------------------------------------
% Job saved on 25-Jul-2016 15:01:31 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6685)
...
matlabbatch{11}.spm.spatial.preproc.channel.vols(1) = cfg_dep('Gunzip Files: Gunzipped Files', substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{':'}));
