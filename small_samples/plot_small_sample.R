...
# # One-sample tests
# # Load data from CSV
allsimudat_k05 <- load_data_from_csv('^test2_k005_n20.*_nominal', '/Users/camaumet/simus/', iter)
allsimudat_k10 <- load_data_from_csv('^test2_k010_n20.*_nominal', '/Users/camaumet/simus/', iter)
allsimudat_k25 <- load_data_from_csv('^test2_k025_n20.*_nominal*', '/Users/camaumet/simus/', iter)
allsimudat_k50 <- load_data_from_csv('^test2_k050_n20.*_nominal*', '/Users/camaumet/simus/', iter)
allsimudat_k25_n100 <- load_data_from_csv('^test2_k025_n100.*_nominal', '/Users/camaumet/simus/', iter)
