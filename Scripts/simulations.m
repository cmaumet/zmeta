...
%     nStudies = numel(nSubjects);
    ...
    subjectPerStudiesScheme = {'identical', 'extreme_large', 'extreme_small', 'very_variable'};
...
%             nSubjects = get_n_subjects_per_studies(nStudies);
            ...
            switch subjectNumberScheme
                ...
                case {'extreme_large'}
                    nSubjects = [ones(1, nStudies*4/5) ones(1, nStudies*1/5)*2]*AVG_NUM_SUB;
                case {'extreme_small'}
                    nSubjects = [ones(1, nStudies*4/5) ones(1, nStudies*1/5)*0.5]*AVG_NUM_SUB;
                case {'very_variable'}
                    nSubjects = linspace(AVG_NUM_SUB/2,AVG_NUM_SUB*2,nStudies);
                otherwise
                  error('')
            end
