...
allsimudat$p_upper <- qbeta(0.025, allsimudat$k, allsimudat$nSimu^3-allsimudat$k+1)
allsimudat$z_upper <- qnorm(allsimudat$p_upper, lower.tail=FALSE)
allsimudat$p_lower <- qbeta(0.975, allsimudat$k, allsimudat$nSimu^3-allsimudat$k+1)
