...
matlab -nodisplay -r "addpath('$cwd');addpath('$cwd/lib');meta_sim('/srv/storage/empenn@storage2.rennes.grid5000.fr/cmaumet',false,fullfile('$cwd', '..', 'spm12'), $2, $3, $4, $5, $6);quit"
